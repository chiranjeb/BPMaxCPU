...
void bpmax(long M, long N, long T1, long T2, long T3, long T1in, long T2in, long T3in, int* seq1, int* seq2, float**** FTable){
	///Parameter checking
	if (!((M >= 8 && N >= 8 && T1 >= 1 && T2 >= 1 && T3 >= 1 && T1in >= 1 && T2in >= N && T3in >= 1))) {
	...
	#define S_1(i1,j1,i2,i3,i4) bpmax_inner_reductions(M,N,i3,j1+i3,T1in,T2in,T3in,FTable,S2[0],seq2,FTable[i3][j1+i3])
	...
	{
		//Domain
		//{i1,j1,i2,j2,i4|M+i1==0 && M>=8 && N>=8 && T1>=1 && T2>=1 && T3>=1 && T1in>=1 && T2in>=N && T3in>=1 && i2>=0 && j1>=0 && M>=j1+i2+1 && j2>=0 && i4>=j2 && N>=i4+1}
		//{i1,j1,i2,i3,i4|i4==1 && i2==M && i1==1 && i3>=0 && j1>=0 && M>=j1+i3+1 && M>=8 && N>=8 && T1>=1 && T2>=1 && T3>=1 && T1in>=1 && T2in>=N && T3in>=1}
		//{i1,j1,i2,i3,i4|i4==0 && i3==1 && i1==1 && i2>=0 && M>=j1+i2+1 && j1>=1 && M>=8 && N>=8 && T1>=1 && T2>=1 && T3>=1 && T1in>=1 && T2in>=N && T3in>=1}
		//{i,i1,i2,i3,i4|i4==0 && i3==0 && i2==0 && i1==0 && i==0 && M>=8 && N>=8 && T1>=1 && T2>=1 && T3>=1 && T1in>=1 && T2in>=N && T3in>=1}
		//{i,i1,i2,i3,i4|i4==0 && i3==0 && i2==0 && i1==0 && i==0 && M>=8 && N>=8 && T1>=1 && T2>=1 && T3>=1 && T1in>=1 && T2in>=N && T3in>=1}
		//{i1,j1,i2,i3,i4|i4==0 && i3==0 && i1==1 && i2>=0 && j1>=0 && M>=j1+i2+1 && M>=8 && N>=8 && T1>=1 && T2>=1 && T3>=1 && T1in>=1 && T2in>=N && T3in>=1}
		int c2,c3,c4,c5;
