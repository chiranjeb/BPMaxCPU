...
void bpmax_max_r0_single(long M, long N, long N_sec, long N_tile, long N_tile_div_MR, long N_tile_div_NR, long MR, long NR, float****** FTable_6D_1, float****** FTable_6D_2, float****** FTable_6D, float****** FTable_6D_3){
	///Parameter checking
