...
setSpaceTimeMap(prog, rootSystem, equation_s1,                "( i                ->  i,    0,     0,     0,   0,      0,    0)");
setSpaceTimeMap(prog, rootSystem, equation_s2,                "( i                ->  i,    0,     0,     0,   0,      0,    0)");
setSpaceTimeMap(prog, rootSystem, outer_reduction_label,      "(i1,j1             ->  1, j1-i1,   i1,  j1-4,   0,      0,    0)");
setSpaceTimeMap(prog, rootSystem, inner_reduction_label,      "(i1,j1             ->  1, j1-i1,   i1,  j1-3,   0,      0,    0)");
...
setSpaceTimeMapForUseEquationOptimization(prog, rootSystem, inner_reduction_label, 0, 0, 
      											...
      											"(i1,j1 ->  1,   j1-i1,  i1,  j1-6,    -1, -1, -1)",
      											"(i1,j1 ->  M+M,  -1,     -1,  -1,     -1, -1, -1)");
setMemorySpaceForUseEquationOptimization(prog, rootSystem, inner_reduction_label, 0, 0, "S2");
