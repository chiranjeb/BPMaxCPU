...
initialize_FTable = "UseEquation_FTable_elementwise_ops";
...
setSpaceTimeMap(prog, rootSystem, initialize_FTable,          "(i1,j1             ->  1,  j1-i1,  i1,  0,     0)");
setSpaceTimeMap(prog, rootSystem, outer_reduction_label,      "(i1,j1             ->  1,  j1-i1,  i1,  1,     0)");
setSpaceTimeMap(prog, rootSystem, inner_reduction_label,      "(i1,j1             ->  1,  j1-i1,  M,  i1,     1)");
...
setSpaceTimeMapForUseEquationOptimization(prog, rootSystem, initialize_FTable, 0, 4, 
      											...
      											"(i1,j1 ->  M+M,  -1,     -1,  -1,     0)");
setMemorySpaceForUseEquationOptimization(prog, rootSystem, initialize_FTable, 0, 4, "FTable");
...
setSpaceTimeMapForUseEquationOptimization(prog, rootSystem, initialize_FTable, 1, 0, 
      											...
      											"(i1,j1 ->  1,   j1-i1,  i1,  j1-3,    0)",
      											"(i1,j1 ->  M+M,  -1,     -1,  -1,     0)");
setMemorySpaceForUseEquationOptimization(prog, rootSystem, initialize_FTable, 1, 0, "FTable_elementwise_ops");      
