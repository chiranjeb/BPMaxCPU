...
setSpaceTimeMap(prog, rootSystem, outer_reduction_label,      "(i1,j1             ->  1, j1-i1,   i1,  j1-4,   0)");
setSpaceTimeMap(prog, rootSystem, inner_reduction_label,      "(i1,j1             ->  1, j1-i1,   i1,  j1-3,   0)");
