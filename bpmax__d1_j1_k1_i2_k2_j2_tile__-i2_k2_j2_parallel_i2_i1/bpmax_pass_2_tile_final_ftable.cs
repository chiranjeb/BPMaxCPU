...
setSpaceTimeMap(prog, rootSystem, "NR_FTable_2", "(i1,j1,i2,j2,k2    ->  1, j1-i1,   M,  i1,    -i2,    k2,    j2)", 
                                                 "(i1,j1,i2,j2       ->  1, j1-i1,   M,  i1,    -i2,    i2-1,  j2)");                                                                           
...
# Set space time map for the first output of the Use equation : NR_FTable                                          
setSpaceTimeMapForUseEquationOptimization(prog, rootSystem, label, 1, 0, 
      											"(i1,j1 -> -1,   -1,     -1,  -1,      0, 0, 0)",
      											"(i1,j1 ->  1,   j1-i1,  i1,  j1-3,    0, 0, 0)",
      											"(i1,j1 ->  M+M,  -1,     -1,  -1,     0, 0, 0)");
setMemorySpaceForUseEquationOptimization(prog, rootSystem, label, 1, 0, "NR_FTable");
