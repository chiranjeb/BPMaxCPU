...
void bpmax_inner_reductions(long, long, long, long, long, long, long, long, long, long, int**, float****, float**, float**, float****);
...
void bpmax(long M, long N, long N_sec, long N_tile, long R, long MR, long NR, long P, int* seq1, int* seq2, float****** FTable){
	...
	#define S2(i1,j1,i2,j2,i4,i5,i6) bpmax_ftable_init(M,N,N_sec,N_tile,(i4==0)?R:0, (i4==0&& i5 == 0)?R:0,i2,j1+i2,i4,i5,seq1,seq2_t,S1[0],S2_C[0][i4][i5],FTable[i2][j1+i2][i4][i5])
	...
	#define S5(i1,j1,i2,j2,i4,i5,i6) bpmax_outer_south_west(M,N,N_sec,N_tile,(i4 == 0)?R:0,(i4 == 0 && i5 == 0)?R:0,MR,NR,i2,j1+i2,i4,i5,seq1,S1[0],FTable[i2+1][j1+i2-1][i4][i5],FTable[i2][j1+i2][i4][i5])
	#define S6(i,j,i2,i3,i4,i5,i6) bpmax_inner_reductions(M,N,N_sec,N_tile,R,MR,NR,P,i4,j+i4,seq2_t,S2_C[0],FTable_Pack_A[thread_id],FTable_Pack_B[thread_id],FTable[i4][j+i4])
	{
		//Domain
