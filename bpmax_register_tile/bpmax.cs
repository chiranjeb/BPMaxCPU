...
setSpaceTimeMap(prog, rootSystem, outer_reduction_label,      "( i, j             ->  2,    j-i,   i,  1,     0)");
...
setSpaceTimeMapForUseEquationOptimization(prog, rootSystem, outer_reduction_label, 0, 3, 
      											...
      											"(i1,j1 ->  M+M,  -1,     -1,  -1,     -1)");
setMemorySpaceForUseEquationOptimization(prog, rootSystem, outer_reduction_label, 0, 3, "S1");
