...
#define FTable_2D_section(i3,j3) FTable_2D_section[i3][j3]

void bpmax_matrix_max_plus_collections(long M, long N, long N_sec, long N_tile, long MR, long NR, long I1, long J1, long K1, long I2, long J2, float**** FTable_A, float**** FTable_B, float**** FTable_C, float** FTable_2D_section){
	///Parameter checking
	...
	#define S0(i3,j3) FTable_2D_section(i3,j3) = 0
	{
		//Domain
