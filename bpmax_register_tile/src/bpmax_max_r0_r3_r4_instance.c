...
void bpmax_max_r0_r3_r4_instance(long M, long N, long N_sec, long N_tile, long MR, long NR, long I1, long J1, long K1, float**** FTable_A, float**** FTable_B, float** S1, float**** FTable_4D){
	///Parameter checking
