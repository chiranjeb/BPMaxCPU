...
void bpmax_inner_reductions(long M, long N, long N_sec, long N_tile, long MR, long NR, long I1, long J1, int* seq2, float**** S2, float**** S2_A, float**** S2_B, float**** FTable_A, float**** FTable_B, float**** FTable_C){
	///Parameter checking
	...
	#define S5(i,j,i2,i3) transform_section_like_B_for_register_tile(M,N,N_sec,N_tile,MR,NR,-i,j,FTable_C,FTable_B[-i][j])
	{
		//Domain
