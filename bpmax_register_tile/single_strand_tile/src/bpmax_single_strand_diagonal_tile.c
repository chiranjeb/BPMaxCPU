...
void bpmax_single_strand_diagonal_tile(long M, long N, long N_sec, long N_tile, long MR, long NR, long I2, long J2, int** seq2_t, float** S_C_I2_J2){
	///Parameter checking
	if (!((M >= 3 && N >= 16 && N_sec >= 4 && N_tile >= 4 && MR >= 1 && NR >= 1 && I2 >= 0 && J2 >= I2 && N_sec >= J2+1))) {
	...
	{
		//Domain
		//{i,j,i2|i2==j+1 && M>=3 && N>=16 && N_sec>=4 && N_tile>=4 && MR>=1 && NR>=1 && I2>=0 && J2>=I2 && N_sec>=J2+1 && 0>=i && N_tile+i>=0 && 0>=i+j-3 && j>=0 && N_tile>=j+1}
		//{i,j,i2|i2==j+1 && N_tile+i>=1 && i+j>=4 && M>=3 && N>=16 && N_sec>=4 && N_tile>=4 && MR>=1 && NR>=1 && I2>=0 && J2>=I2 && N_sec>=J2+1 && 0>=i && N_sec>=I2+1 && j>=1 && N_tile>=j+1 && J2>=0}
		//{i,j,i2|i+j==-1 && M>=3 && N>=16 && N_sec>=4 && N_tile>=4 && MR>=1 && NR>=1 && I2>=0 && J2>=I2 && N_sec>=J2+1 && N_tile>=i2+1 && i+i2>=4 && J2>=0 && i2>=1 && N_tile+i>=1 && N_sec>=I2+1 && 0>=i}
		//{i0,i1,i2|i0+i1>=0 && i2>=i1+1 && M>=3 && N>=16 && N_sec>=4 && N_tile>=4 && MR>=1 && NR>=1 && I2>=0 && J2>=I2 && N_sec>=J2+1 && 0>=i0 && N_tile+i0>=1 && i1>=0 && N_tile>=i1+1 && i2>=1 && N_tile>=i2+1 && N_sec>=I2+1 && i0+i2>=4 && J2>=0}
		int c1,c2,c3;
