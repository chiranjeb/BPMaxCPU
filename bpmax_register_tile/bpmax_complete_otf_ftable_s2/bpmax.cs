...
sw_instance_label      = "UseEquation_FTable_sw";

setSpaceTimeMap(prog, rootSystem, equation_s1,                "( i              ->  0,      0,   i,    0,  0,   0,  0)");
setSpaceTimeMap(prog, rootSystem, equation_seq2_t,            "( i              ->  0,      1,   i,    0,  0,   0,  0)");
setSpaceTimeMap(prog, rootSystem, equation_s2,                "( i              ->  0,      2,   i,    0,  0,   0,  0)");
setSpaceTimeMap(prog, rootSystem, initialize_FTable,          "(i1, j1, i2, j2  ->  2,  j1-i1,  i1,   -1, i2,  j2,  0)");
setSpaceTimeMap(prog, rootSystem,  sw_instance_label,         "(i1, j1, i2, j2  ->  2,  j1-i1,  i1,   -1, i2,  j2,  1)");
setSpaceTimeMap(prog, rootSystem, outer_reduction_label,      "( i, j, k        ->  2,    j-i,   i,    k,  0,   0,  0)");
setSpaceTimeMap(prog, rootSystem, inner_reduction_label,      "( i, j           ->  2,    j-i,   M,    0,  i,   0,  0)");
...
setSpaceTimeMapForUseEquationOptimization(prog, rootSystem, sw_instance_label, 0, 0, 
      											"(i1, j1 -> -1,   -1,     -1,  -1, 0)",
      											"(i1, j1 ->  1,    i1,    j1,  -1, 0)",
      											"(i1, j1 ->  M,   -1,     -1,  -1, 0)");
setMemorySpaceForUseEquationOptimization(prog, rootSystem, sw_instance_label, 0, 0, "seq1");     
setSpaceTimeMapForUseEquationOptimization(prog, rootSystem, sw_instance_label, 0, 1, 
      											"(i1,j1 -> -1,   -1,     -1,  -1,      -1)",
      											"(i1,j1 ->  1,   j1-i1,  i1,  j1-7,    -1)",
      											"(i1,j1 ->  M+M,  -1,     -1,  -1,     -1)");
setMemorySpaceForUseEquationOptimization(prog, rootSystem, sw_instance_label, 0, 1, "S1");
setSpaceTimeMapForUseEquationOptimization(prog, rootSystem, sw_instance_label, 0, 2, 
      											"(i1,j1 -> -1,   -1,     -1,  -1,      -1)",
      											"(i1,j1 ->  1,   j1-i1,  i1,  j1-7,    -1)",
      											"(i1,j1 ->  M+M,  -1,     -1,  -1,     -1)");
setMemorySpaceForUseEquationOptimization(prog, rootSystem, sw_instance_label, 0, 2, "FTable");
setSpaceTimeMapForUseEquationOptimization(prog, rootSystem, sw_instance_label, 1, 0, 
      											          "(i1 -> -1,   -1,     -1,  -1    )",
      											          "(i1->  1,    i1,      0,  -3    )",
      											          "(i1->  M+M,  -1,     -1,  -1    )");
setMemorySpaceForUseEquationOptimization(prog, rootSystem, sw_instance_label, 1, 0, "FTable_sw");
...
setSpaceTimeMapForUseEquationOptimization(prog, rootSystem, inner_reduction_label, 0, 1, 
      											...
      											"(i1,j1 ->  1,   j1-i1,  i1,  j1-6,    -1)",
      											"(i1,j1 ->  M+M,  -1,     -1,  -1,     -1)");
setMemorySpaceForUseEquationOptimization(prog, rootSystem, inner_reduction_label, 0, 1, "S2_C");
setSpaceTimeMapForUseEquationOptimization(prog, rootSystem, inner_reduction_label, 0, 2, 
      											"(i1,j1 -> -1,   -1,     -1,  -1,      -1)",
      											"(i1,j1 ->  1,   j1-i1,  i1,  j1-7,    -1)",
      											"(i1,j1 ->  M+M,  -1,     -1,  -1,     -1)");
setMemorySpaceForUseEquationOptimization(prog, rootSystem, inner_reduction_label, 0, 2, "FTable_Pack_A");
setSpaceTimeMapForUseEquationOptimization(prog, rootSystem, inner_reduction_label, 0, 3, 
      											"(i1,j1 -> -1,   -1,     -1,  -1,      -1)",
      											"(i1,j1 ->  1,   j1-i1,  i1,  j1-7,    -1)",
      											"(i1,j1 ->  M+M,  -1,     -1,  -1,     -1)");
setMemorySpaceForUseEquationOptimization(prog, rootSystem, inner_reduction_label, 0, 3, "FTable_Pack_B");
