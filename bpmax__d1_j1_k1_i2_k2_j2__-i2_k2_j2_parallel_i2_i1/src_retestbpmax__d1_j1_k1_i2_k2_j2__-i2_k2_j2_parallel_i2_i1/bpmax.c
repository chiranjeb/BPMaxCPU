...
void bpmax(long M, long N, int* seq1, int* seq2, float**** FTable){
	...
	#define S_1(i,j,i2,i3,i4,i5,i6,i7) S1(i4,i3+i4) = __max_float((S1(i4+1,i3+i4-1))+(e_intra_score(seq1(i4),seq1(i3+i4))),reduce_bpmax_S1_1(M,N,i4,i3+i4,S1))
	#define S_2(i,j,i2,i3,i4,i5,i6,i7) S2(i4,i3+i4) = 0
	#define S3(i,j,i2,i3,i4,i5,i6,i7) S2(i4,i3+i4) = __max_float((S2(i4+1,i3+i4-1))+(e_intra_score(seq2(-i4+N-1),seq2(-i3-i4+N-1))),reduce_bpmax_S2_1(M,N,i4,i3+i4,S2))
	#define S4(i1,j1,i2,j2,i4,i5,i6,i7) FTable(i4,j1+i4,-i5,i6) = e_inter_score(seq1(i4),seq2(i5+N-1))
	#define S5(i1,j1,i2,j2,i4,i5,i6,i7) FTable(i4,j1+i4,-i5,i6) = __max_float((FTable(i4+1,j1+i4-1,-i5,i6))+(e_intra_score(seq1(i4),seq1(j1+i4))),__max_float((FTable(i4,j1+i4,-i5+1,i6-1))+(e_intra_score(seq2(i5+N-1),seq2(-i6+N-1))),__max_float((S1(i4,j1+i4))+(S2(-i5,i6)),__max_float(FTable(i4,j1+i4,-i5,i6),__max_float(NR_FTable1(i4,i6),__max_float(NR_FTable2(i4,i6),__max_float(FTable(i4,j1+i4,-i5,i6),FTable(i4,j1+i4,-i5,i6))))))))
	#define S6(i1,j1,i2,j2,i4,i5,i6,i7) FTable(i4,j1+i4,-i5,i6) = __max_float((FTable(i4+1,j1+i4-1,-i5,i6))+(e_intra_score(seq1(i4),seq1(j1+i4))),__max_float(0,__max_float((S1(i4,j1+i4))+(S2(-i5,i6)),__max_float(FTable(i4,j1+i4,-i5,i6),__max_float(NR_FTable1(i4,i6),__max_float(NR_FTable2(i4,i6),__max_float(FTable(i4,j1+i4,-i5,i6),FTable(i4,j1+i4,-i5,i6))))))))
	#define S7(i1,j1,i2,j2,i4,i5,i6,i7) FTable(i4,j1+i4,-i5,i6) = __max_float((FTable(i4+1,j1+i4-1,-i5,i6))+(e_intra_score(seq1(i4),seq1(j1+i4))),__max_float(0,__max_float((S1(i4,j1+i4))+(S2(-i5,i6)),__max_float(0,__max_float(0,__max_float(0,__max_float(FTable(i4,j1+i4,-i5,i6),FTable(i4,j1+i4,-i5,i6))))))))
	#define S8(i1,j1,i2,j2,i4,i5,i6,i7) FTable(i4,j1+i4,-i5,i6) = __max_float(0,__max_float((FTable(i4,j1+i4,-i5+1,i6-1))+(e_intra_score(seq2(i5+N-1),seq2(-i6+N-1))),__max_float((S1(i4,j1+i4))+(S2(-i5,i6)),__max_float(FTable(i4,j1+i4,-i5,i6),__max_float(NR_FTable1(i4,i6),__max_float(NR_FTable2(i4,i6),__max_float(FTable(i4,j1+i4,-i5,i6),FTable(i4,j1+i4,-i5,i6))))))))
	#define S9(i1,j1,i2,j2,i4,i5,i6,i7) FTable(i4,j1+i4,-i5,i6) = __max_float(0,__max_float((FTable(i4,j1+i4,-i5+1,i6-1))+(e_intra_score(seq2(i5+N-1),seq2(-i6+N-1))),__max_float((S1(i4,j1+i4))+(S2(-i5,i6)),__max_float(0,__max_float(NR_FTable1(i4,i6),__max_float(NR_FTable2(i4,i6),__max_float(0,0)))))))
	#define S10(i1,j1,i2,j2,i4,i5,i6,i7) FTable(i4,j1+i4,-i5,i6) = __max_float(0,__max_float(0,__max_float((S1(i4,j1+i4))+(S2(-i5,i6)),__max_float(FTable(i4,j1+i4,-i5,i6),__max_float(NR_FTable1(i4,i6),__max_float(NR_FTable2(i4,i6),__max_float(FTable(i4,j1+i4,-i5,i6),FTable(i4,j1+i4,-i5,i6))))))))
	#define S11(i1,j1,i2,j2,i4,i5,i6,i7) FTable(i4,j1+i4,-i5,i6) = __max_float(0,__max_float(0,__max_float((S1(i4,j1+i4))+(S2(-i5,i6)),__max_float(0,__max_float(NR_FTable1(i4,i6),__max_float(NR_FTable2(i4,i6),__max_float(0,0)))))))
	#define S12(i1,j1,i2,j2,i4,i5,i6,i7) FTable(i4,j1+i4,-i5,i6) = __max_float(0,__max_float(0,__max_float((S1(i4,j1+i4))+(S2(-i5,i6)),__max_float(0,__max_float(0,__max_float(0,__max_float(FTable(i4,j1+i4,-i5,i6),FTable(i4,j1+i4,-i5,i6))))))))
	#define S18(i1,j1,i2,j2,i4,i5,i6,i7) FTable(i2,j1+i2,i4,i6) = 1.401298464324817E-45
	#define S19(i1,j1,i2,j2,i4,i5,i6,i7) FTable(i2,j1+i2,i4,i6) = 1.401298464324817E-45
	...
	#define S15(i0,i1,i2,i3,i4,i5,i6,i7) {float __temp__ = (S2(-i5,i6))+(FTable(i4,i1+i4,i6+1,i7)); NR_FTable2(i4,i7) = __max_float(NR_FTable2(i4,i7),__temp__); }
	{
		...
		//{i1,j1,i2,j2,i4,i5,i6,i7|i7==0 && j2==0 && i2==M && i1==1 && j1>=4 && i5+i6>=4 && M>=3 && N>=3 && j1+i5+i6>=1 && i4>=0 && N+i5>=1 && M>=j1+i4+1 && 0>=i5 && i6>=0 && N>=i6+1 && M>=i4+1 && j1+i4>=0}
		//{i1,j1,i2,j2,i4,i5,i6,i7|i7==0 && j2==0 && i2==M && i1==1 && j1>=4 && i5+i6>=1 && M>=3 && N>=3 && 0>=i5+i6-3 && j1+i5+i6>=1 && i4>=0 && M>=i4+1 && M>=j1+i4+1 && 0>=i5 && j1+i4>=0 && N>=i6+1}
		//{i1,j1,i2,j2,i4,i5,i6,i7|i7==0 && i5+i6==0 && j2==0 && i2==M && i1==1 && j1>=4 && N>=3 && M>=3 && i4>=0 && M>=i4+1 && M>=j1+i4+1 && 0>=i5 && j1+i4>=0 && N+i5>=1}
		//{i1,j1,i2,j2,i4,i5,i6,i7|i7==0 && j2==0 && i2==M && i1==1 && j1>=1 && i5+i6>=4 && M>=3 && N>=3 && 0>=j1-3 && j1+i5+i6>=1 && N+i5>=1 && i6>=0 && i4>=0 && N>=i6+1 && M>=j1+i4+1 && 0>=i5}
		//{i1,j1,i2,j2,i4,i5,i6,i7|i7==0 && j2==0 && i2==M && j1==0 && i1==1 && i5+i6>=4 && M>=3 && N>=3 && N+i5>=1 && i6>=0 && i4>=0 && N>=i6+1 && M>=i4+1 && 0>=i5}
		//{i1,j1,i2,j2,i4,i5,i6,i7|i7==0 && j2==0 && i2==M && i1==1 && j1>=1 && i5+i6>=1 && M>=3 && N>=3 && 0>=j1-3 && 0>=i5+i6-3 && j1+i5+i6>=1 && 0>=i5 && N>=i6+1 && i4>=0 && M>=j1+i4+1}
		//{i1,j1,i2,j2,i4,i5,i6,i7|i7==0 && j2==0 && i2==M && j1==0 && i1==1 && i5+i6>=1 && M>=3 && N>=3 && 0>=i5+i6-3 && 0>=i5 && N>=i6+1 && i4>=0 && M>=i4+1}
		//{i1,j1,i2,j2,i4,i5,i6,i7|i7==0 && i5+i6==0 && j2==0 && i2==M && i1==1 && j1>=1 && N>=3 && M>=3 && 0>=j1-3 && M>=j1+i4+1 && 0>=i5 && i4>=0 && N+i5>=1}
