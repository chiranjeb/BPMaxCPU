...
#setMemoryMap(prog, system_bpmax_inner_reductions_finalize,    "NR_C_I2_J2_1",      "NR_C_I2_J2_1",   "(i2,j2-> j2)");

setMemorySpace(prog, system_bpmax_inner_reductions_finalize,  "C_I2_J2", "C_pointwise_diag, NR_C_I2_J2, NR_C_I2_J2_1, C_I2_J2");

setSpaceTimeMap(prog, system_bpmax_inner_reductions_finalize, "NR_C_I2_J2_1",      "(i,j,k ->   -2N_tile+1,  i,   k,  j)", 
                                                      		                       "(i,j   ->   -2N_tile+1,  i,   -1,  j)");
