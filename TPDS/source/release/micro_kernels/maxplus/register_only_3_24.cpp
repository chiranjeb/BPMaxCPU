...
void register_tile_3_24(long ldK, float *A, float *B, float *C, int ldC)
{
    ...
    __m256 aa3 = _mm256_broadcast_ss(aptr+2);
    ...
    for ( long k = 0; k < ldK; k++)
    {
        ...
        cc4 = _mm256_add_ps( aa1, bb2 );
        c_patch_01 = _mm256_max_ps( cc4, c_patch_01 );
        cc5 = _mm256_add_ps( aa2, bb2 );
        c_patch_11 = _mm256_max_ps( cc5, c_patch_11 );
        cc6 = _mm256_add_ps( aa3, bb2 );
        c_patch_21 = _mm256_max_ps( cc6, c_patch_21 );
        
        cc1 = _mm256_add_ps( aa1, bb3 );
        c_patch_02 = _mm256_max_ps( cc1, c_patch_02 );
        cc2 = _mm256_add_ps( aa2, bb3 );
        c_patch_12 = _mm256_max_ps( cc2, c_patch_12 );
        cc3 = _mm256_add_ps( aa3, bb3 );
