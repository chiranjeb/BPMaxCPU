...
\input{content/1_introduction/introduction}

\section{Background}\label{sec:background}
\input{content/2_background_related_work/background}

\section{BPMax Optimization}\label{sec:method}
\input{content/3_method/method}

\section{Implementation}\label{sec:implementation}
\input{content/4_Implementation/implementation}

\section{Result}\label{sec:result}
\input{content/5_results/results}


\section{Conclusion}\label{sec:future_directions}
\input{content/6_conclusions/conclusions}
