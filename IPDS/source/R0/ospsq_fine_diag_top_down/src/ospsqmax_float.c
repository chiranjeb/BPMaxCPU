...
void ospsqmax_float(long M, long N, int* seq1, int* seq2, float**** FTable){
	...
	#define S0(i1,j1,i2,j2,i4,i5) FTable(j1,i1+j1,j2,i4) = seq2(j2)
	#define S1(i1,j1,i2,j2,i4,i5) FTable(j1,i1+j1,j2,i4) = seq1(j1)
	#define S2(i1,j1,i2,j2,i4,i5) FTable(j1,i1+j1,j2,i4) = FTable(j1,i1+j1,j2,i4)
	...
	{
		//Domain
		//{i1,j1,i2,j2,i4,i5|i5==i4 && i2==j1 && i1==0 && M>=2 && N>=2 && j2>=0 && N>=j2+1 && i4>=j2 && j1>=0 && M>=j1+1 && N>=i4+1}
		//{i1,j1,i2,j2,i4,i5|i5==j2 && i4==j2 && i2==i1+j1 && i1>=1 && M>=2 && N>=2 && j1>=0 && M>=j1+1 && N>=j2+1 && j2>=0 && M>=i1+j1+1}
		//{i1,j1,i2,j2,i4,i5|i5==i4 && i2==i1+j1 && i1>=1 && i4>=j2+1 && M>=2 && N>=2 && j1>=0 && j2>=0 && N>=i4+1 && M>=i1+j1+1}
		//{i1,j1,i2,j2,i4,i5|i4==j2-1 && i2==j1-1 && M>=2 && N>=2 && j1>=0 && i1>=1 && N>=i5+1 && i5>=j2+1 && M>=i1+j1+1 && j2>=0}
		//{i0,i1,i2,i3,i4,i5|i2>=i1 && i0+i1>=i2+1 && i4>=i3 && i5>=i4+1 && M>=2 && N>=2 && i1>=0 && N>=i5+1 && M>=i2+1 && i3>=0 && i4>=-1 && N>=i4+1 && M>=i0+i1+1 && i2>=-1 && i5>=i3+1 && i0>=1}
