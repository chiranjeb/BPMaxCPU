...
void register_tile_4_16(int ldK, float *A, float *B, float *C_p, int ldA, int ldB, int ldC)
{
    int i = 0, j =0;
    ...
    __m256 c_patch_30 = _mm256_loadu_ps( &C_p( 3, 0) );
    __m256 c_patch_31 = _mm256_loadu_ps( &C_p( 3, 8) );
    ...
    _mm256_storeu_ps( &C_p(3, 0), c_patch_30 );
    _mm256_storeu_ps( &C_p(3, 8), c_patch_31 );
